...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:extension/f:value[x] 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:extension/f:value[x]/f:code 1</sch:title>
    <sch:rule context="f:Practitioner/f:extension/f:value[x]/f:code">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:qualification/f:identifier/f:use</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:qualification/f:identifier/f:value</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:qualification/f:issuer/f:display</sch:title>
